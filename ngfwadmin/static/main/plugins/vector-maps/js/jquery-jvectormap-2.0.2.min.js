...
var jvm = {
  ...
  whenImageLoaded: function(url, login, password){
...
jvm.Proj = {
   ...
   * @param {Number} x X of point in Cartesian state as integer
   * @param {Number} y Y of point in Cartesian state as integer
   * @param {Number} c Central meridian in degrees
   */
